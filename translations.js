...
const translations = {
    ...
    quiz_multi_14_q: "🛏️Sei a dormire dalla Sofi e siete tutti riuniti in salotto, che cosa ti chiede?",
    ...
    quiz_multi_15_ans: [2],
    quiz_multi_16_q: "🌲POV: ti sei perso alle 3 di notte in una foresta oscurissima, non hai campo e le nuvole ti impediscono di orientarti nel cielo. Cosa farebbe Sofia?",
    quiz_multi_16_opts: ["si costruisce un rifugio per la notte","va a caccia di bambini da mangiare (è comunista)","si mette a piangere","cerca una guardia di frontiera bulgara con cui litigare"],
    quiz_multi_16_ans: [1,2,3],
    quiz_multi_17_q: "🏛️Quale è il monumento preferito di sofia?",
    quiz_multi_17_opts: ["Basilica di Santa Sofia","la sede di Morozzo della Gnocca","Parlamento bulgaro","Il cesso di casa sua"],
    quiz_multi_17_ans: [2],
        // Navigation
        brand: "DOTTORESSA!!!",
    ...
    quiz_multi_13_ans: [0,2],
    quiz_multi_14_q: "🛏️ You're sleeping at Sofi's and everyone is in the living room, what does she ask you?",
    ...
    quiz_multi_15_ans: [2],
    quiz_multi_16_q: "🌲POV: It's 3 AM, you're lost in a pitch-dark forest, no signal and clouds block the sky. What would Sofia do?",
    quiz_multi_16_opts: ["She builds a shelter for the night","She hunts children to eat (she's a communist)","She starts crying","She looks for a Bulgarian border guard to argue with"],
    quiz_multi_16_ans: [1,2,3],
    quiz_multi_17_q: "🏛️What is Sofia's favorite monument?",
    quiz_multi_17_opts: ["Saint Sofia Basilica","Morozzo della Gnocca headquarters","Bulgarian Parliament","Her home toilet"],
    quiz_multi_17_ans: [2],
        // Navigation
        brand: "DOCTOR!!!",
    ...
    quiz_multi_13_ans: [0,2],
    quiz_multi_14_q: "🛏️ Спиш у София и всички са в хола, какво те пита?",
    ...
    quiz_multi_15_ans: [2],
    quiz_multi_16_q: "🌲POV: Загубил/а си се в 3 през нощта в много тъмна гора, нямаш обхват и облаците ти пречат да се ориентираш по небето. Какво би направила София?",
    quiz_multi_16_opts: ["Ще си построи заслон за нощта","Ще тръгне да ловува деца за ядене (комунистка е)","Ще започне да плаче","Ще търси български граничар, с когото да се скара"],
    quiz_multi_16_ans: [1,2,3],
    quiz_multi_17_q: "🏛️Кой е любимият паметник на София?",
    quiz_multi_17_opts: ["Базилика Света София","Щабът на Мороцо дела Гнока","Българският парламент","Тоалетната в дома ѝ"],
    quiz_multi_17_ans: [2],
        // Navigation
        brand: "ДОКТОРЕ!!!",
    ...
    quiz_multi_13_ans: [0,2],
    quiz_multi_14_q: "🛏️Ты ночуешь у Софии, все в гостиной, что она спрашивает?",
    ...
    quiz_multi_15_ans: [2],
    quiz_multi_16_q: "🌲POV: Ты потерялся в 3 часа ночи в очень тёмном лесу, нет связи, облака закрывают небо. Что бы сделала София?",
    quiz_multi_16_opts: ["Построит убежище на ночь","Пойдёт охотиться на детей, чтобы их съесть (она коммунистка)","Начнёт плакать","Поищет болгарского пограничника, чтобы поругаться"],
    quiz_multi_16_ans: [1,2,3],
    quiz_multi_17_q: "🏛️Какой любимый памятник Софии?",
    quiz_multi_17_opts: ["Базилика Святой Софии","Штаб-квартира Мороццо делла Гнока","Болгарский парламент","Туалет в её доме"],
    quiz_multi_17_ans: [2],
        // Navigation
        brand: "ДОКТОР!!!",
    ...
    quiz_multi_13_ans: [0,2],
    quiz_multi_14_q: "🛏️Tu dors chez Sofi et tout le monde est réuni dans le salon, que te demande-t-elle ?",
    ...
    quiz_multi_15_ans: [2],
    quiz_multi_16_q: "🌲POV : Il est 3h du matin, tu es perdu dans une forêt très sombre, pas de réseau et les nuages t'empêchent de t'orienter dans le ciel. Que ferait Sofia ?",
    quiz_multi_16_opts: ["Elle construit un abri pour la nuit","Elle part chasser des enfants à manger (elle est communiste)","Elle se met à pleurer","Elle cherche un garde-frontière bulgare pour se disputer"],
    quiz_multi_16_ans: [1,2,3],
    quiz_multi_17_q: "🏛️Quel est le monument préféré de Sofia ?",
    quiz_multi_17_opts: ["Basilique Sainte-Sophie","Le siège de Morozzo della Gnocca","Le Parlement bulgare","Les toilettes de chez elle"],
    quiz_multi_17_ans: [2],
        // Navigation
        brand: "DOCTEURE!!!",
