...
const translations = {
    ...
    quiz_multi_5_ans: [0],
    quiz_multi_6_q: "🧬 Защо София се казва 'noveli'?",
    quiz_multi_6_opts: ["в чест на прародител, победил турците при Шипка", "Защото noveli е патроним", "защото на български означава нов живот"],
    quiz_multi_6_ans: [1],
    ...
    quiz_multi_5_opts: ["Димитрòва", "Димìтрова"],
    quiz_multi_5_ans: [0],
    quiz_multi_6_q: "🧬 Почему София называется 'noveli'?",
    quiz_multi_6_opts: ["в честь предка, победившего турок при Шипке", "Потому что noveli — это патроним", "потому что по-болгарски значит новая жизнь"],
    quiz_multi_6_ans: [1],
