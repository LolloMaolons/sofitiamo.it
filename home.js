document.addEventListener('DOMContentLoaded', () => {
    ...
    if (homeQuizContainer) { // Controlla se l'elemento esiste prima di procedere
        const quizzes = [
            {
    ...
    // --- Iconic Moments Gallery (ora chiamata Home Gallery) ---
    const homeGallery = document.getElementById('home-gallery');
    if (homeGallery) { // Controlla se l'elemento esiste
